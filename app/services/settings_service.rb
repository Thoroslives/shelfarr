class SettingsService
  ...
  DEFINITIONS = {
    ...
    webhook_topic: { type: "string", default: "", category: "webhook", description: "Optional topic field included in webhook JSON payload (used by ntfy, MQTT, and other topic-based receivers for message routing)" },
